...
const Hero = () => {
  ...
  return (
        ...
        <section className="pt-12 bg-none sm:pt-16 w-[100vw] ">
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center ">
              ...
              <motion.p className="mt-5  hero-text font-bold leading-tight text-black sm:leading-tight sm:text-5xl lg:text-6xl lg:leading-normal text-2xl" initial={{opacity:0,y:-500}} animate={{opacity:1,y:0}}
              transition={{duration:0.5}}>
              ...
              <div className="px-8 sm:items-center sm:justify-center sm:px-0 sm:space-x-5 sm:flex mt-9">
                ...
                >
                 ...
                 {!console&&<Link 
                  href="/admin"
                  title=""
                  className="inline-flex items-center justify-center w-full px-6 py-3 mt-4 text-lg font-bold text-gray-800 transition-all duration-200 border-2 border-gray-400 sm:w-auto sm:mt-0 rounded-xl font-pj focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-900 focus:bg-gray-900 hover:text-white focus:text-white hover:border-gray-900 focus:border-gray-900"
                  role="button"
                >
    ...
    duration={{duration:2}}
    >
        <img src="/admin.png" alt=""  className=""/>
    </motion.div>
