      ...
      <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm sm:h-10 lg:h-24">
        ...
        >
          <div className="flex items-center justify-between ">
            <Link
              href="/"
              className="flex-none text-xl font-semibold dark:text-black text-black"
            >
              <img
                src="/cld.png"
                alt=""
            ...
            <div className="md:hidden">
              <button
                type="button"
                className="hs-collapse-toggle p-2 inline-flex justify-center items-center gap-2 rounded-full border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm   dark:text-black dark:hover:text-black "
          ...
          >
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
              <Link
                className="font-medium text-black md:py-6 dark:text-black"
                href="/#features"
                aria-current="page"
              >
                Features
              ...
              <Link
                className="font-medium text-black hover:text-black md:py-6 dark:text-gray-white"
                href="/#price"
              >
                Pricing
              </Link>
              ...
              {!user&&<Link
                ...
                className="flex items-center gap-x-2 font-medium text-black hover:text-blue-600 md:border-l md:border-gray-300 md:my-6 md:pl-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500"
              >
                <svg
                  className="w-4 h-4"
